...
CREATE TABLE `tnt_fixdata_asses`  (
  ...
  CONSTRAINT `fk_tnt_fixdata_asses_tnt_student_1` FOREIGN KEY (`fds_std_number`) REFERENCES `tnt_student` (`stu_num`) ON DELETE RESTRICT ON UPDATE RESTRICT,
