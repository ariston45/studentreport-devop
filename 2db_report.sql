...
INSERT INTO `tnt_class` VALUES ('cls.93', 'm.1', 'Kelas 5A');
...
CREATE TABLE `tnt_classgrade`  (
  ...
  `cg_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `cd_tnt` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
