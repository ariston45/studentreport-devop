...
<li>
	<a href="<?=base_url('sekolah')?>" class="dropdown-toggle no-arrow <?php if ($segments[1] == 'sekolah') {echo 'active';}?>">
		<span class="micon dw dw-calendar1"></span><span class="mtext">Sekolah</span>
	</a>
</li>

<li class="">
	<a href="javascript:;" class="dropdown-toggle no-arrow <?php if ($segments[1] == 'users') {echo 'active';}?>">
