...
<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
	...
	<hr>
	<div class="mb-20">
		<form action="<?= base_url($content['pg_menu_url'] . '/eksekusi-tambah-kelompok-pelajaran') ?>" method="post" enctype="multipart/form-data">
			<div class="form-group row">
				<label class="col-sm-12 col-md-3 col-form-label">Nama Kelompok Mata Pelajaran</label>
				<div class="col-sm-12 col-md-9">
					<input type="text" name="kelompok" class="form-control col-12 fh-35" placeholder="Nama mata pelajaran ..">
				</div>
			</div>
