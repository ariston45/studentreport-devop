			...
			<div class="col-md-9 col-sm-12">
				<div class="tab-content">
										...
										<td>
											<div class="dropdown">
												...
												<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
													<a class="dropdown-item" href="<?=base_url('customers/'.$data['tenant_group_id'].'/user-manager/detail/'.$value['u_id'])?>"><i class="dw dw-eye"></i> View</a>
													<a class="dropdown-item" href="<?=base_url('customers/'.$data['tenant_group_id'].'/user-manager/edit/'.$value['u_id'])?>"><i class="icon-copy dw dw-edit2"></i> Edit</a>
					...
					<div class="tab-pane fade" id="adduser" role="tabpanel">
						<div class="pd-20">
							<form action="<?=base_url('customers/exe-adduser-customer/'.$data['tenant_group_id'])?>" method="post" enctype="multipart/form-data">
								<?= csrf_field(); ?>
