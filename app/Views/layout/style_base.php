...
<link rel="stylesheet" type="text/css" href="<?=base_url('public')?>/vendors/styles/style.max.css">
<link rel="stylesheet" type="text/css" href="<?=base_url('public')?>/vendors/styles/style.custom.css">
